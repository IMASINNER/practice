package com.cyzc.test.Distance;
...
public class gdGetDistance {
    ...
    private static String getLonLat(String address){
        ...
        String queryUrl = "http://restapi.amap.com/v3/geocode/geo?key=2752ae903c2be01972f497c590c91fda&address="+address;
    ...
    private static long getDistance(String startLonLat, String endLonLat){
        ...
        String queryUrl = "http://restapi.amap.com/v3/distance?key=2752ae903c2be01972f497c590c91fda&origins="+startLonLat+"&destination="+endLonLat;
